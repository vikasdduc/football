...
import '../../createTeam/chooseCaptain.dart';
import '../../createTeam/createTeam.dart';
import '../../createTeam/teamPreview.dart';
import 'chooseCap.dart';

class AddTeam extends StatefulWidget {
  final list, index, compId, matchID, time, name, size, fee, totalPrize, winner,coupon;

  AddTeam(this.list, this.index, this.compId, this.matchID, this.time,
      this.name, this.size, this.fee, this.totalPrize, this.winner,this.coupon);
