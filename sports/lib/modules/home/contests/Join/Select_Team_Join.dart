...
class select_team_join extends StatefulWidget {
  final code,match;
  List<GetTeam> dataTeams;


  select_team_join(this.code,this.match, this.dataTeams);

  @override
  State<select_team_join> createState() => _select_team_joinState();
}

class _select_team_joinState extends State<select_team_join> {
                                  ...
                                  child: Container(
                                    decoration: BoxDecoration(
                                      image: DecorationImage(
                                        image:
                                        AssetImage(ConstanceData.cricketGround,),
                                        fit: BoxFit.cover,
                                        opacity: 0.9,
                                      ),
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          access_network()
                              ...
                              widget.dataTeams[selectedRadioTile].id.toString())
                              .then((value2) {
