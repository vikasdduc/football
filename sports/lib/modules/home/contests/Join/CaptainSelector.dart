...
class CaptainSelector extends StatefulWidget {
  final List<players> list;
  final compId, matchID, code, time,teama,teamb;

  CaptainSelector(this.list, this.compId, this.matchID, this.code, this.time,this.teama, this.teamb);

  @override
  State<CaptainSelector> createState() => _CaptainSelectorState();
}

class _CaptainSelectorState extends State<CaptainSelector> {
  int cap, vc;
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => TeamPreViewPage(widget.list,
                          widget.list[cap].pid, widget.list[vc].pid,widget.teama,widget.teamb),
                    ),
                  );
                },
                child: Padding(
        ...
        .then((value) => {
              ...
              access_network()
                ...
                Fluttertoast.showToast(
                    ...
                    textColor: Colors.white,
                    fontSize: 16.0);
                access_network().getTeam().then((value2) {
