...
class EditTeamPage extends StatefulWidget {
  ...
  EditTeamPage(
      this.current, this.time, this.mylist, this.teamA, this.teamB, this.id);
                        ...
                        if (BOWL >= 3 && BOWL <= 6) {
                          if (widget.teamA.length == 11) {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => ChooseCaptainAgainPage(
                                    widget.teamA,
                                    widget.time,
                                    widget.id,
                                    widget.current.teama.short_name,
                                    widget.current.teamb.short_name,
                                    widget.current.match_id.toString(),
                                  widget.current.Competition.cid.toString(),
                                ),
                              ),
                            );
                          } else {
