...
class stats_completed extends StatefulWidget {
final List<players> list;
final match_new data;

stats_completed({Key key, this.list, this.data}) : super(key: key);

@override
_statsState createState() => _statsState();
}

class _statsState extends State<stats_completed> {
